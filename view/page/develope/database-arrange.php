...
<div class="alert alert-info">
    ...
    <ul>
        ...
        <li>將會在本機資料庫確認表格為<strong>已建立</strong>狀態，若表格<strong>不存在</strong>則會<strong><span class="text-error">建立表格</span></strong></li>
        <li>將會產生相對應的 model 檔案，若已經有<strong>相同名稱</strong>的檔案則會<strong><span class="text-error">略過此步驟</span></strong></li>
        <li>將會產生相對應的 dao 檔案，若已經有<strong>相同名稱</strong>的檔案則會<strong><span class="text-error">略過此步驟</span></strong></li>
...
$(document).ready(function() {
    ...
    $('#arrange-database-form').ajaxForm({
        ...
        url: '/action/develope/arrange-database',
        type: 'post',
        dataType: 'html'
