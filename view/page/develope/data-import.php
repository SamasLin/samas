<form id="import-data-form" class="form-horizontal">
                    ...
                    <tbody>
                        ...
                        foreach ($exist_table_array as $table_name) {
                            ...
                            if (in_array($table_name, $data_table_array)) {
                                ...
                                if (   $data_last_modify_time == '--'
                                    || $file_last_modify_time < $data_last_modify_time
                                ) {
...
$(document).ready(function() {
    ...
    function importDataValidate(formData, jqForm, options) {
    ...
    function importDataResponse(response, statusText, xhr, $form) {
    ...
    $('#import-data-form').ajaxForm({

        beforeSubmit: importDataValidate,
        success:      importDataResponse,
        url: '/action/develope/import-data',
        type: 'post',
        dataType: 'json'
