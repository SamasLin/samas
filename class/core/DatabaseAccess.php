...
class DatabaseAccess
{
    ...
    public $build_time;
    private $link;
    private static $exclude_database = array(
        'information_schema',
        'mysql',
        'performance_schema'
    );
    ...
    public function getAllDatabases()
    {
        ...
        foreach ($query_instance as $instance_data) {
            ...
            $database_array[] = $instance_data['Database'];

        }// end foreach ($query_instance as $instance_data)

        return array_diff($database_array, self::$exclude_database);

    }// end function getAllDatabases
    ...
    public function getAllTables()
    {
        ...
        foreach ($query_instance as $instance_data) {
            ...
            $table_array[] = $instance_data['Tables_in_'.strtolower($database_name)];
    ...
    public function getTableLastModifyTime($table_name)
    {
        ...
        return StringUtil::dateFormat($last_mofity_time, 0, 19);
